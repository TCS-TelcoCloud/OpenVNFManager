...
if os.environ.get('VNFSVCCLIENT_DEBUG'):
...
class VNFSvcClientMixin(object):

    USER_AGENT = 'python-vnfsvcclient'


class HTTPClient(VNFSvcClientMixin):
    ...
    def _get_endpoint_url(self):
        ...
        try:
            ...
            # rollback to authenticate() to handle case when vnfsvc client
        ...
        for endpoint in body.get('endpoints', []):
            if (endpoint['type'] == 'vnfservice' and
...
class SessionClient(VNFSvcClientMixin):
