...
class CreateCommand(VNFSvcCommand, show.ShowOne):
    ...
    def get_data(self, parsed_args):
        ...
        if info:
            if self.resource == 'monitor':
                print(_('Network Service %s status:') % self.resource,
...
class ShowCommand(VNFSvcCommand, show.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        #
        # However, now the same functionality of filtering the vdu parameters is done
        # client side with everytime request to the server going as
