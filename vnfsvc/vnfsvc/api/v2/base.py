...
from vnfsvc.api import api_common
from vnfsvc.api.v2 import attributes
from vnfsvc.api.v2 import resource as wsgi_resource
...
class Controller(object):
    ...
    def __init__(self, plugin, collection, resource, attr_info,
        ...
        self._notifier = n_rpc.get_notifier('vnfservice')
    ...
    def delete(self, request, id, **kwargs):
        ...
        data = obj_deleter(request.context, id, **kwargs)
