...
def Resource(controller, faults=None, deserializers=None, serializers=None):
    ...
    def resource(request):
        ...
        try:
        ...
        except (exceptions.VNFSvcException,
            ...
            body = serializer.serialize(
                {'VnfsvcError': get_exception_data(e)})
            ...
            body = serializer.serialize(
                {'VnfsvcError': get_exception_data(
        ...
        #    content_type = ''
        #    body = None
        if status == 204 and 'path' in body:
            content_type = ''
            status = 200
            body = body
...
def get_exception_data(e):
    ...
    Vnfsvc client for the v2 API expects exceptions to have 'type', 'message'
...
def translate(translatable, locale):
    ...
    if isinstance(translatable, exceptions.VNFSvcException):
