...
from vnfsvc.openstack.common import context

DEFAULT_URL = "__default__"
TRANSPORTS = {}

_ALIASES = {
    'vnfsvc.common.rpc.impl_kombu': 'rabbit',
    'vnfsvc.common.rpc.impl_qpid': 'qpid',
    'vnfsvc.common.rpc.impl_zmq': 'zmq',
}
...
def setup():
    oslo_messaging.set_transport_defaults('vnfsvc')
...
def get_rpc_server(transport, topic, endpoint):
    ...
    cfg.CONF.import_opt('host', 'vnfsvc.service')
