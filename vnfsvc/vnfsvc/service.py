...
class VNFSvcApiService(WsgiService):
    """Class for vnfsvc-api service."""

    @classmethod
    def create(cls, app_name='vnfsvc'):
...
class Service(v_rpc.Service):
    ...
    def report_state(self):
        ...
        # Todo(gongysh) report state to vnfsvc server
        pass

def prepare_service(argv=None):
    gettextutils.install('vnfsvc')
    ...
    if argv is None:
        argv = sys.argv
    cfg.CONF(argv[1:], project='vnfsvc')
    log.setup('vnfsvc')
    messaging.setup()
